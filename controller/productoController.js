...
let productController = {
 ...
 //       console.log('-----MUESTRO EL LITERAL');
  ...
  //      console.log(erroresControlados);
    ...
    update: (req, res) => {
        console.log("Entré al UPDATE cuando apreté Editar")
       
        console.log('imprimo los campos que vienen del body')
        // Veo las propiedades de los campos
        console.log(req.params.id)
        console.log(req.body);
        console.log('El campo Image: '+ req.body.image);
        console.log('El campo ImageOld: ' + req.body.oldImage);


        // Veo las propiedades del archivo, esto viaja por post
        console.log('imprimo los campos que vienen del file')
        console.log('Todo el req.file : '+ req.file);
        ...
        console.log('imprimo los errores')
        console.log('La variable errores' +  errores)
        ...
        if (errores.errors.length > 0) {
            ...
            return res.render('editProduct', {
              // ACA TOME EL id  QUE VIENE POR PARAMETRO
              // Y LO ENVIO A LA VISTA  
